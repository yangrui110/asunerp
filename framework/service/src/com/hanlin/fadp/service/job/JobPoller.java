...
import com.hanlin.fadp.service.config.ServiceConfigListener;
import com.hanlin.fadp.service.config.model.ServiceConfig;
import com.hanlin.fadp.service.config.model.ThreadPool;
...
public final class JobPoller implements ServiceConfigListener {
    ...
    private JobPoller() {
        if (pollEnabled()) {
            jobManagerPollerThread = new Thread(new JobManagerPoller(), "Fadp-JobPoller");
    ...
    private static class JobInvokerThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(Runnable runnable) {
            return new Thread(runnable, "Fadp-JobQueue-" + created.getAndIncrement());
        }
    }
