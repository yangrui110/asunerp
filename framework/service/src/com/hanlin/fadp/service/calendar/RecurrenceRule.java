...
public class RecurrenceRule {
    ...
    private Date getNextFreq(long startTime, long fromTime) {
        ...
        long nextStartTime = startTime; // 下次开始时间.

        while (nextStartTime < fromTime) { // 成立. 假设为 DAILY.
            ...
            case DAILY:
                cal.add(Calendar.DAY_OF_MONTH, getIntervalInt()); // 获取间隔.
                break;
