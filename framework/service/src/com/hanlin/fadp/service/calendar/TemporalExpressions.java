...
public class TemporalExpressions implements Serializable {
    ...
    public static class DateRange extends TemporalExpression {
        protected final com.hanlin.fadp.base.util.DateRange range;
        ...
        public DateRange(Date start, Date end) {
            this.range = new com.hanlin.fadp.base.util.DateRange(start, end);
        ...
        /** Returns the contained <code>com.hanlin.fadp.base.util.DateRange</code>.
         * @return The contained <code>com.hanlin.fadp.base.util.DateRange</code>
         */
        public com.hanlin.fadp.base.util.DateRange getDateRange() {
            return this.range;
        }
