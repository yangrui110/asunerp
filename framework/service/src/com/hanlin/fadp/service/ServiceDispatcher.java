...
import com.hanlin.fadp.entity.transaction.DebugXaResource;
...
import com.hanlin.fadp.service.config.model.StartupService;
import com.hanlin.fadp.service.eca.ServiceEcaRule;
import com.hanlin.fadp.service.eca.ServiceEcaUtil;
import com.hanlin.fadp.service.engine.GenericEngine;
import com.hanlin.fadp.service.engine.GenericEngineFactory;
import com.hanlin.fadp.service.group.ServiceGroupReader;
...
import com.hanlin.fadp.service.semaphore.ServiceSemaphore;
...
public class ServiceDispatcher {
    ...
    public Map<String, Object> runSync(String localName, ModelService modelService, Map<String, ? extends Object> params, boolean validateOut) throws ServiceAuthException, ServiceValidationException, GenericServiceException {
        ...
        try {
            ...
            if (modelService.useTransaction) { // 默认使用事务.
