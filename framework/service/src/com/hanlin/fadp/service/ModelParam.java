...
public class ModelParam implements Serializable {
    ...
    protected String java2wsdlType() throws WSDLException {
        if (ObjectType.instanceOf(java.lang.Character.class, this.type)) {
            ...
            return "sql-Timestamp";
        } else if (ObjectType.instanceOf(com.hanlin.fadp.entity.GenericValue.class, this.type)) {
            return "eeval-";
        } else if (ObjectType.instanceOf(com.hanlin.fadp.entity.GenericPK.class, this.type)) {
            return "eepk-";
