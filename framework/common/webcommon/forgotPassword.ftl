...
<center>
  <div class="screenlet login-screenlet">
    ...
    <div class="screenlet-body">
      <form method="post" action="<@fadpUrl>forgotPassword${previousParams!}</@fadpUrl>" name="forgotpassword">
        ...
        <a href='<@fadpUrl>authview</@fadpUrl>' class="button">${uiLabelMap.CommonGoBack}</a>
