...
<#assign
  dayValueList = Static["com.hanlin.fadp.service.calendar.ExpressionUiHelper"].getDayValueList(locale)
  monthValueList = Static["com.hanlin.fadp.service.calendar.ExpressionUiHelper"].getMonthValueList(locale)
/>
...
<#macro fieldErrors fieldName>
  <#if errorMessageList?has_content>
    <#assign fieldMessages = Static["com.hanlin.fadp.base.util.MessageString"].getMessagesForField(fieldName, true, errorMessageList)>
    <ul>
...
<#macro fieldErrorsMulti fieldName1 fieldName2 fieldName3 fieldName4>
  <#if errorMessageList?has_content>
    <#assign fieldMessages = Static["com.hanlin.fadp.base.util.MessageString"].getMessagesForField(fieldName1, fieldName2, fieldName3, fieldName4, true, errorMessageList)>
    <ul>
      <#list fieldMessages as errorMsg>
        <li class="errorMessage">${errorMsg}</li>
      </#list>
