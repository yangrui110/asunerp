...
under the License.
-->
<script language="javascript" type="text/javascript" src="<@fadpContentUrl>/images/jquery/plugins/flot/excanvas.min.js</@fadpContentUrl>"></script>
<script language="javascript" type="text/javascript" src="<@fadpContentUrl>/images/jquery/plugins/flot/jquery.flot.js</@fadpContentUrl>"></script>
<script language="javascript" type="text/javascript" src="<@fadpContentUrl>/images/jquery/plugins/flot/jquery.flot.pie.js</@fadpContentUrl>"></script>
