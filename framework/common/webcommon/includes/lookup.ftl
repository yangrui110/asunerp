...
<head>
    ...
    function initJQuery() {
        if (typeof(jQuery) == 'undefined') {
            if (!jQueryLibLoaded) {
                ...
                document.write("<scr" + "ipt type=\"text/javascript\" src=\"<@fadpContentUrl>/images/jquery/jquery-1.11.0.min.js</@fadpContentUrl>\"></scr" + "ipt>");
                document.write("<scr" + "ipt type=\"text/javascript\" src=\"<@fadpContentUrl>/images/jquery/jquery-migrate-1.2.1.js</@fadpContentUrl>\"></scr" + "ipt>");
            }
    ...
    initJQuery();
    //]]></script>
    <script language="javascript" src="<@fadpContentUrl>/images/selectall.js</@fadpContentUrl>" type="text/javascript"></script>
    ...
    <#if layoutSettings.styleSheets?has_content>
        <#list layoutSettings.styleSheets as styleSheet>
            <link rel="stylesheet" href="<@fadpContentUrl>${styleSheet}</@fadpContentUrl>" type="text/css"/>
        </#list>
    </#if>
