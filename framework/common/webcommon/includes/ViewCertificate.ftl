...
<#assign components = Static["com.hanlin.fadp.base.component.ComponentConfig"].getAllComponents()!/>
<#if (requestParameters.certString?has_content)>
    <#assign cert = Static["com.hanlin.fadp.base.util.KeyStoreUtil"].pemToCert(requestParameters.certString)/>
</#if>
<div class="screenlet">
        ...
        <#assign keystores = component.getKeystoreInfos()!/>
          <#list keystores as store>
            <#if (store.isTrustStore())>
              <tr>
                <form method="post" action="<@fadpUrl>/importIssuerProvision</@fadpUrl>">
