...
import com.hanlin.fadp.service.ServiceSynchronization;
...
public class CommonServices {
    ...
    public static Map<String, Object> byteBufferTest(DispatchContext dctx, Map<String, ?> context) {
        ...
        String outputPath1 = fadpHome + (fileName1.startsWith("/") ? fileName1 : "/" + fileName1);
        String outputPath2 = fadpHome + (fileName2.startsWith("/") ? fileName2 : "/" + fileName2);
