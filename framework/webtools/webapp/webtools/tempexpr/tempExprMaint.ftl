...
<#if temporalExpression?has_content>
  ...
  <#if !"INTERSECTION.UNION.DIFFERENCE.SUBSTITUTION"?contains(temporalExpression.tempExprTypeId)>
    <form name="updateExpression" method="post" action="<@fadpUrl>updateTemporalExpression</@fadpUrl>">
  ...
  <#else>
    ...
    <#elseif "INTERSECTION.UNION.DIFFERENCE.SUBSTITUTION"?contains(temporalExpression.tempExprTypeId)>
      <#assign candidateIdList = Static["com.hanlin.fadp.service.calendar.ExpressionUiHelper"].getCandidateIncludeIds(delegator, temporalExpression.tempExprId)/>
...
<#macro CreateForm expressionTypeId="" formContents=NullMacro>
  <form name="${expressionTypeId}" method="post" action="<@fadpUrl>createTemporalExpression</@fadpUrl>">
...
<#macro CreateExprAssocForm formName="" exprAssocType="">
  <form name="${formName}" method="post" action="<@fadpUrl>createTemporalExpressionAssoc</@fadpUrl>">
    <input type="hidden" name="tempExprId" value="${temporalExpression.tempExprId}"/>
