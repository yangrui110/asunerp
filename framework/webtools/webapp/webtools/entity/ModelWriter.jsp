...
under the License.
--%>
<%@ page contentType="text/plain" %><%@ page import="java.util.*, java.io.*, java.net.*, com.hanlin.fadp.base.config.*, com.hanlin.fadp.base.util.*, com.hanlin.fadp.entity.*, com.hanlin.fadp.entity.config.*, com.hanlin.fadp.entity.model.*" %><jsp:useBean id="delegator" type="com.hanlin.fadp.entity.GenericDelegator" scope="request" /><jsp:useBean id="security" type="com.hanlin.fadp.security.Security" scope="request" /><%
try {
