                ...
                <table width="95%" border="1" cellpadding='2' cellspacing='0'>
                    <tr class='entityheader'>
                        <td colspan="5">
                            ...
                            <div>${entity.title}&nbsp;
                                <#if !forstatic>
                                    <a target='main' href="<@fadpUrl>FindGeneric?entityName=${entity.entityName}&amp;find=true&amp;VIEW_SIZE=50&amp;VIEW_INDEX=0</@fadpUrl>">[${uiLabelMap.WebtoolsViewData}]</a>
                                </#if>
                                <#if !forstatic>
                                    <a target='main' href="<@fadpUrl>ArtifactInfo?name=${entity.entityName}&amp;type=entity</@fadpUrl>">[${uiLabelMap.WebtoolsArtifactInfo}]</a>
                                </#if>
                            </div>
