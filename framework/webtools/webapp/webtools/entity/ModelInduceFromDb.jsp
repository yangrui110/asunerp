...
under the License.
--%>
<%@ page import="java.util.*, java.io.*, java.net.*, java.sql.*, com.hanlin.fadp.base.util.*, com.hanlin.fadp.entity.*, com.hanlin.fadp.entity.model.*, com.hanlin.fadp.entity.datasource.*" %><jsp:useBean id="delegator" type="com.hanlin.fadp.entity.GenericDelegator" scope="request" /><jsp:useBean id="security" type="com.hanlin.fadp.security.Security" scope="request" /><%
