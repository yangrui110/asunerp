  ...
  <div class="screenlet-body">
    <#if hasViewPermission>
        ...
        <div class="button-bar">
            <a href="<@fadpUrl>FindGeneric?entityName=${entityName}&amp;find=true&amp;VIEW_SIZE=50&amp;VIEW_INDEX=0</@fadpUrl>" class="smallSubmit">${uiLabelMap.WebtoolsBackToFindScreen}</a>
        </div>
        <br />
        <table class="basic-table hover-bar" cellspacing="0">
            ...
            <#list relations as relation>
                <tr<#if alt_row> class="alternate-row"</#if>>
                    ...
                    <td class="button-col"><a href='<@fadpUrl>FindGeneric?entityName=${relation.relEntityName}&amp;find=true&amp;VIEW_SIZE=50&amp;VIEW_INDEX=0</@fadpUrl>'>${relation.relEntityName}</a></td>
                    <td>${relation.type}</td>
