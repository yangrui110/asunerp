...
-->
    <div>
       <form action="<@fadpUrl>/entitymaint</@fadpUrl>">
            ...
            <td class="button-col">
              <#if entity.viewEntity == 'Y'>
                <#if entity.entityPermissionView == 'Y'>
                  <a href='<@fadpUrl>ViewRelations?entityName=${entity.entityName}</@fadpUrl>'>${uiLabelMap.WebtoolsReln}</a>
                  <a href='<@fadpUrl>FindGeneric?entityName=${entity.entityName}</@fadpUrl>'>${uiLabelMap.WebtoolsFind}</a>
                  <a href='<@fadpUrl>FindGeneric?entityName=${entity.entityName}&amp;find=true&amp;VIEW_SIZE=50&amp;VIEW_INDEX=0</@fadpUrl>'>${uiLabelMap.WebtoolsAll}</a>
                </#if>
              <#else>
                <#if entity.entityPermissionCreate == 'Y'>
                  <a href='<@fadpUrl>ViewGeneric?entityName=${entity.entityName}</@fadpUrl>' title='${uiLabelMap.CommonCreateNew}'>${uiLabelMap.WebtoolsCreate}</a>
                </#if>
                <#if entity.entityPermissionView == 'Y'>
                  <a href='<@fadpUrl>ViewRelations?entityName=${entity.entityName}</@fadpUrl>' title='${uiLabelMap.WebtoolsViewRelations}'>${uiLabelMap.WebtoolsReln}</a>
                  <a href='<@fadpUrl>FindGeneric?entityName=${entity.entityName}</@fadpUrl>' title='${uiLabelMap.WebtoolsFindRecord}'>${uiLabelMap.WebtoolsFind}</a>
                  <a href='<@fadpUrl>FindGeneric?entityName=${entity.entityName}&amp;find=true&amp;VIEW_SIZE=50&amp;VIEW_INDEX=0</@fadpUrl>' title='${uiLabelMap.WebtoolsFindAllRecords}'>${uiLabelMap.WebtoolsAll}</a>
                </#if>
              </#if>
            </td>
            <#if right_col>
