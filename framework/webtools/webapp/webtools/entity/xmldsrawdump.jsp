...
under the License.
--%><%@ page import="java.io.*, java.util.*, java.net.*, org.w3c.dom.*, com.hanlin.fadp.security.*, com.hanlin.fadp.entity.*, com.hanlin.fadp.entity.condition.*, com.hanlin.fadp.entity.util.*, com.hanlin.fadp.base.util.*, com.hanlin.fadp.entity.model.*, com.hanlin.fadp.entity.transaction.*" %><jsp:useBean id="security" type="com.hanlin.fadp.security.Security" scope="request" /><jsp:useBean id="delegator" type="com.hanlin.fadp.entity.GenericDelegator" scope="request" /><%
