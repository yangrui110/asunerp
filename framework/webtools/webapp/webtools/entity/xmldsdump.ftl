...
<#if security.hasPermission("ENTITY_MAINT", session)>
    <a href="<@fadpUrl>xmldsrawdump</@fadpUrl>" class="buttontext" target="_blank">Click Here to Get Data (or save to file)</a>
<#else>
...
<#macro displayButtonBar>
  <div class="button-bar">
    ...
    <a href="<@fadpUrl>xmldsdump?checkAll=true</@fadpUrl>" class="smallSubmit">${uiLabelMap.WebtoolsCheckAll}</a>
    <a href="<@fadpUrl>xmldsdump</@fadpUrl>" class="smallSubmit">${uiLabelMap.WebtoolsUnCheckAll}</a>
  </div>
</#macro>
...
<#if security.hasPermission("ENTITY_MAINT", session)>
  ...
  <form method="post" action="<@fadpUrl>xmldsdump</@fadpUrl>" name="entityExport">
      ...
      <table>
        <tr>
          ...
          <#list modelEntities as modelEntity>
            ...
            <#if checkAll == "true" && modelEntity.getClass().getName() == "com.hanlin.fadp.entity.model.ModelViewEntity">
                <#assign check = "false"/>
            </#if>
