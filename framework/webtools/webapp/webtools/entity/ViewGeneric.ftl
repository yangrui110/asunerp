...
<div class="screenlet">
  ...
  <div class="screenlet-body">
    ...
    <div class="button-bar">
      <a href='<@fadpUrl>FindGeneric?entityName=${entityName}&amp;find=true&amp;VIEW_SIZE=50&amp;VIEW_INDEX=0</@fadpUrl>' class="buttontext">${uiLabelMap.WebtoolsBackToFindScreen}</a>
      <#if enableEdit = "false">
        <#if hasCreatePermission>
          <a href='<@fadpUrl>ViewGeneric?entityName=${entityName}&amp;enableEdit=true</@fadpUrl>' class="buttontext create">${uiLabelMap.CommonCreateNew}</a>
          <a href="<@fadpUrl>ViewGeneric?${curFindString}&amp;enableEdit=true</@fadpUrl>" class="buttontext">${uiLabelMap.CommonEdit}</a>
        </#if>
        <#if value?has_content>
          <#if hasDeletePermission>
            <a href='<@fadpUrl>UpdateGeneric?UPDATE_MODE=DELETE&amp;${curFindString}</@fadpUrl>' class="buttontext delete">${uiLabelMap.WebtoolsDeleteThisValue}</a>
          </#if>
        </#if>
      </#if>
    </div>
    ...
    <#if enableEdit = "true">
      <#if hasUpdatePermission || hasCreatePermission>
        ...
        <div id="area2" class="screenlet">
          ...
          <form action='<@fadpUrl>UpdateGeneric?entityName=${entityName}</@fadpUrl>' method="post" name="updateForm">
                ...
                <#if newFieldNoPkList?has_content>
                  ...
                  <tr<#if alt_row> class="alternate-row"</#if>>
                    ...
                    <td>
                      ...
                      <a href="<@fadpUrl>ViewGeneric?${curFindString}</@fadpUrl>" class="smallSubmit">${uiLabelMap.CommonCancel}</a>
                    </td>
                  </tr>
                </#if>
              </#if>
          ...
          <div id="area${(relation_index + 2)}" class="topcontainerhidden">
            <div class="screenlet-title-bar">
              <ul>
                ...
                <li><a href="<@fadpUrl>FindGeneric?${relation.encodeRelatedEntityFindString}&amp;find=true</@fadpUrl>">${uiLabelMap.CommonFind}</a></li>
                <#if relation.valueRelated?has_content>
                  <li><a href="<@fadpUrl>ViewGeneric?${relation.encodeRelatedEntityFindString}</@fadpUrl>">${uiLabelMap.CommonView}</a></li>
                </#if>
                <#if hasAllCreate || relCreate>
                  <li><a href="<@fadpUrl>ViewGeneric?${relation.encodeRelatedEntityFindString}&amp;enableEdit=true</@fadpUrl>">${uiLabelMap.CommonCreate}</a></li>
                </#if>
              </ul>
              <br class="clear"/>
            </div>
            ...
            <#else>
              ...
              <#else/>
              <a href="<@fadpUrl>FindGeneric?${relation.encodeRelatedEntityFindString}&amp;find=true</@fadpUrl>" class="buttontext">${uiLabelMap.CommonFind}</a>
              </#if>
            </#if>
          </div>
      </#list>
  ...
  <div class="screenlet">
    ...
    <div class="screenlet-body">
      <p>
      <#if value?has_content>
        <#assign valueXmlDoc = Static["com.hanlin.fadp.entity.GenericValue"].makeXmlDocument([value]) />
        ${Static["com.hanlin.fadp.base.util.UtilXml"].writeXmlDocument(valueXmlDoc)?replace("\n", "<br />")?replace("    ", "&nbsp;&nbsp;&nbsp;&nbsp;")}
      </#if>
      </p>
    </div>
  </div>
