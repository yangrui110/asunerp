...
import com.hanlin.fadp.service.eca.ServiceEcaUtil;
import com.hanlin.fadp.service.ModelPermGroup;
import com.hanlin.fadp.service.ModelPermission;
...
List getEcaListForService(String selectedService) {
    ecaMap = com.hanlin.fadp.service.eca.ServiceEcaUtil.getServiceEventMap(selectedService);
        ...
        ecaValue.each { curRule ->
            ...
            if (actionsVal) {
                ...
                actionsVal.each { curAction ->
                    ...
                    if (com.hanlin.fadp.service.eca.ServiceEcaAction.equals(actionClass)) {
                        actionMap = [:];
...
if (selectedService) {
    ...
    if (curServiceModel != null) {
        ...
        curServiceMap.definitionLocation = curServiceModel.definitionLocation.replaceFirst("file:/" + System.getProperty("fadp.home") + "/", "");
    ...
    serviceNames.each { serviceName ->
        ...
        if (constraint && curServiceModel != null) {
            ...
            if (canIncludeService && constraintName.equals("definitionLocation")) {
                fullPath = "file:/" + System.getProperty("fadp.home") + "/" + constraintVal;
