...
<#if !artifactInfo??>
    ...
    <div>
      <form name="ArtifactInfoByName" method="post" action="<@fadpUrl>ArtifactInfo</@fadpUrl>" class="basic-form">
    ...
    <div>
      <form name="ArtifactInfoByNameAndType" method="post" action="<@fadpUrl>ArtifactInfo</@fadpUrl>" class="basic-form">
...
<#else/>
    ...
    <#if artifactInfo.getType() == "entity">
        <div><a href="<@fadpUrl>FindGeneric?entityName=${artifactInfo.modelEntity.getEntityName()}&amp;find=true&amp;VIEW_SIZE=50&amp;VIEW_INDEX=0</@fadpUrl>">All Entity Data</a></div>
        <h2>Entity Fields</h2>
        <table>
...
<#macro displayServiceEcaArtifactInfo serviceEcaArtifactInfo>
    ...
    <#if serviceEcaArtifactInfo.serviceEcaRule.getEcaActionList()?has_content>
        ...
        <#list serviceEcaArtifactInfo.serviceEcaRule.getEcaActionList() as ecaAction>
            <tr>
                <td><a href="<@fadpUrl>ArtifactInfo?type=${artifactInfo.getType()}&amp;uniqueId=${ecaAction.getServiceName()}</@fadpUrl>">${ecaAction.getServiceName()}</a></td>
...
<a href="<@fadpUrl>ArtifactInfo?type=${type}&amp;uniqueId=${uniqueId?url('ISO-8859-1')}</@fadpUrl>">${displayName}</a>
</#macro>
