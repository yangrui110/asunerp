 ...
 * under the License.
 */
package com.hanlin.fadp.webtools;
...
import com.hanlin.fadp.base.util.UtilPlist;
import com.hanlin.fadp.base.util.UtilProperties;
import com.hanlin.fadp.base.util.UtilURL;
import com.hanlin.fadp.base.util.UtilValidate;
import com.hanlin.fadp.base.util.UtilProperties.UtilResourceBundle;
...
import com.hanlin.fadp.entity.model.ModelIndex;
...
import com.hanlin.fadp.entityext.EntityGroupUtil;
...
import com.hanlin.fadp.webtools.artifactinfo.ArtifactInfoFactory;
import com.hanlin.fadp.webtools.artifactinfo.ServiceArtifactInfo;
...
public class WebToolsServices {
    ...
    public static Map<String, Object> entityImport(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        if (UtilValidate.isNotEmpty(fmfilename) && (UtilValidate.isNotEmpty(fulltext) || url != null)) {
            ...
            try {
                Configuration conf = com.hanlin.fadp.base.util.template.FreeMarkerWorker.getDefaultOfbizConfig();
    ...
    public static Map<String, Object> entityImportReaders(DispatchContext dctx, Map<String, Object> context) {
        ...
        String groupNameToUse = overrideGroup != null ? overrideGroup : "com.hanlin.fadp";
            ...
            for (String pName : packageNames) {
                ...
                for (String entityName: entities) {
                    ...
                    if (search == null || entityName.toLowerCase().indexOf(search.toLowerCase()) != -1) {
                        ...
                        entityLocation = entityLocation.replaceFirst(System.getProperty("fadp.home") + "/", "");
