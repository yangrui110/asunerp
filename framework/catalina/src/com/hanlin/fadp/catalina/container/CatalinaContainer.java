...
package com.hanlin.fadp.catalina.container;
...
import com.hanlin.fadp.base.container.ContainerConfig.Container.Property;
...
public class CatalinaContainer implements Container {
    ...
    public static final String CATALINA_HOSTS_HOME = System.getProperty("fadp.home") + "/framework/catalina/hosts";
    ...
    public void init(String[] args, String name, String configFile) throws ContainerException {
        ...
        // set catalina_home
        System.setProperty(Globals.CATALINA_HOME_PROP, System.getProperty("fadp.home") + "/" + this.catalinaRuntimeHome);
        ...
        tomcat = new Tomcat();
        tomcat.setBaseDir(System.getProperty("fadp.home"));
    ...
    private Engine createEngine(ContainerConfig.Container.Property engineConfig) throws ContainerException {
        ...
        if (logDir != null) {
            ...
            if (!logDir.startsWith("/")) {
                logDir = System.getProperty("fadp.home") + "/" + logDir;
            }
