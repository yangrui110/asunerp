...
public class ApacheFopWorker {
     ...
     * <code>com.hanlin.fadp.webapp.view.ApacheFopWorker-</code>.
     */
    public static final String tempFilePrefix = "com.hanlin.fadp.webapp.view.ApacheFopWorker-";
        ...
        if (fopFactory == null) {
            synchronized (ApacheFopWorker.class) {
                ...
                try {
                    ...
                    File userConfigFile = FileUtil.getFile(fadpHome + fopPath + "/fop.xconf");
                    ...
                    File fontBaseFile = FileUtil.getFile(fadpHome + fopFontBaseProperty);
