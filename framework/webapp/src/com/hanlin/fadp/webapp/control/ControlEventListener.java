...
public class ControlEventListener implements HttpSessionListener {
    ...
    public void sessionCreated(HttpSessionEvent event) {
        ...
        if (System.getProperty("com.hanlin.fadp.log.session.stats") != null) {
            session.setAttribute("com.hanlin.fadp.log.session.stats", "Y");
        }
    ...
    public void logStats(HttpSession session, GenericValue visit) {
        if (Debug.verboseOn() || session.getAttribute("com.hanlin.fadp.log.session.stats") != null) {
