...
public class ControlServlet extends HttpServlet {
    ...
    /**
     * @Title: configureBsf 
     * @Description: 配置脚本引擎，目前支持两类：一是beanshell脚本，另一类是平台自定义的minilang脚本，扩展脚本的关键
     * @return: void
     */
    protected void configureBsf() {
        String[] bshExtensions = {"bsh"};
        BSFManager.registerScriptingEngine("beanshell", "com.hanlin.fadp.base.util.OfbizBshBsfEngine", bshExtensions);

        String[] jsExtensions = {"js"};
        BSFManager.registerScriptingEngine("javascript", "com.hanlin.fadp.base.util.OfbizJsBsfEngine", jsExtensions);

        String[] smExtensions = {"sm"};
        BSFManager.registerScriptingEngine("simplemethod", "com.hanlin.fadp.minilang.SimpleMethodBsfEngine", smExtensions);
    }

    /**
     * @Title: logRequestInfo 
     * @Description: 记录每次请求的日志，重要部分
     * @param request
     * @return: void
     */
