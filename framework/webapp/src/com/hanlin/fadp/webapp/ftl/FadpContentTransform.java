 ...
 */
public class FadpContentTransform implements TemplateTransformModel {

    public final static String module = FadpContentTransform.class.getName();
    ...
    public Writer getWriter(final Writer out, Map args) {
        ...
        final String imgSize = FadpContentTransform.getArg(args, "variant");
