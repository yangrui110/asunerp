 ...
 */
public class FadpCurrencyTransform implements TemplateTransformModel {

    public static final String module = FadpCurrencyTransform.class.getName();
    ...
    public Writer getWriter(final Writer out, Map args) {
        ...
        final BigDecimal amount = FadpCurrencyTransform.getAmount(args, "amount");
        final String isoCode = FadpCurrencyTransform.getArg(args, "isoCode");
        final String locale = FadpCurrencyTransform.getArg(args, "locale");
