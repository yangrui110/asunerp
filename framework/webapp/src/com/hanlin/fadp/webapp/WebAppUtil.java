...
import com.hanlin.fadp.base.util.UtilXml.LocalErrorHandler;
import com.hanlin.fadp.base.util.UtilXml.LocalResolver;
 ...
 * fadp does not need to be running on Tomcat for this to work.</p>
 */
public final class WebAppUtil {
     ...
     * specified in the <code>fadp-component.xml</code> file and the servlet mapping specified
    ...
    public static String getControlServletPath(WebappInfo webAppInfo) throws IOException, SAXException {
        ...
        for (ServletDef servletDef : webXml.getServlets().values()) {
            if ("com.hanlin.fadp.webapp.control.ControlServlet".equals(servletDef.getServletClass()) || "com.hanlin.fadp.product.category.SeoControlServlet".equals(servletDef.getServletClass())) {
        ...
        if (servletMapping == null) {
            throw new IllegalArgumentException("com.hanlin.fadp.webapp.control.ControlServlet mapping not found in " + webAppInfo.getLocation() + webAppFileName);
        }
