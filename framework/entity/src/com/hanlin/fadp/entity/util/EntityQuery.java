 ...
 * @Description: 实体查询类，关于查询条件设置采用装饰模式进行构建
 * @author: 祖国
...
public class EntityQuery {
    ...
    /**
     * @Title: use 
     * @Description: 根据指定的Delegator构建一个EntityQuery实例，调用构造方法
     * @param delegator 用于查询的delegator
     * @return: EntityQuery 返回一个EntityQuery实体
     */
    ...
    /**
     * @Title:EntityQuery
     * @Description: 根据指定的Delegator构建一个EntityQuery实例
     * @param delegator 用于查询的delegator
     */
    ...
    /**
     * @Title: from 
     * @Description: 设置EntityQuery的实体名属性，并设置DynamicViewEntity对象属性为null
    ...
    /**
     * @Title: from 
     * @Description: 设置EntityQuery的DynamicViewEntity对象属性，并设置查询实体名为null
     * @param dynamicViewEntity DynamicViewEntity对象
     * @return: EntityQuery
     */
    ...
    /**
     * @Title: where 
     * @Description: 设置EntityQuery的查询条件EntityCondition对象属性，
     * @param fields 可变参数，为偶数，成对出现，前者为查询条件，后者为条件的值
     * @return: EntityQuery
     */
    ...
    /**
     * @Title: cache 
     * @Description: 设置查询结果是否从cache中读取或当查询结果没有缓存时，是否写入缓存
     * @return: EntityQuery
     */
    ...
    /**
     * @Title: queryList 
     * @Description: 获取查询结果，调用本类的重载方法
     * @throws GenericEntityException
     * @return: List<GenericValue> 查询结果为实体值对象的list
     */
    ...
    /**
     * @Title: queryOne 
     * @Description: 执行EntityQuery中查询，返回一个查询结果
     * @throws GenericEntityException
     * @return: GenericValue 查询结果记录，为一个
     */
    ...
    /**
     * @Title: makeEntityFindOptions 
     * @Description: 构建默认的查询条件：游标只能向前移动、查询获取的大小、最大获取的row、查询结果是否不能重复
