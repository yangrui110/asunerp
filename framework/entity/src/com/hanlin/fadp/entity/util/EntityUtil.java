...
import com.hanlin.fadp.entity.condition.EntityDateFilterCondition;
...
public class EntityUtil {
    ...
    /**
     * @Title: getOnly 
     * @Description: 从list中获取第一个元素，一般list的大小为一，多余一个则抛出异常信息
     * @param values 待从中获取元素的列表
     * @return: GenericValue 一个实体值对象
     */
