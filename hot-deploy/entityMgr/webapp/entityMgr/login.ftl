...
#h1{
	...
	<script src="/images/entityMgr/js/jquery-1.9.1.min.js"></script>
		...
		<div id="formdiv">
			<form method="post" action="main">
				  ...
				  <p  style="margin-top:10px">
				    ...
				    <span id="forget" class="log"><a href="/webtools/control/forgotPassword" style="color:#fff;text-align:none;">忘记密码</a></span>
				    <span style="margin-left: 40px" id="login" class="log">登入</span>
				  </p>
	          </form>
       </div>
		<h2 id="h2"></h2>
