<#assign animation='[@routerTransition]'>
<div *ngIf="!showDataTableOnly" ${animation}>
  <app-page-header [heading]="'${appHeader}'" [icon]="'fa-wrench'"></app-page-header>
  ...
  <#elseif field.component=='selectDept'> <#--选部门组件-->
      ...
      <div class="card mt-2">
        <div class="card-header" *ngIf="list${entityName}Service.canAdd(approveAction)">
          <button class="btn btn-outline-primary btn-xsm" [edit${entityName}] [approveAction]="approveAction" (dataSavedEvent)="dataSaved($event)"><i class="fa fa-plus-circle"></i>新增
          </button>
