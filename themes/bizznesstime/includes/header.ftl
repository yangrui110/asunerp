...
<head>
    ...
    <link rel="shortcut icon" href="<@fadpContentUrl>${StringUtil.wrapString(shortcutIcon)}</@fadpContentUrl>" />
    </#if>
    <#if layoutSettings.styleSheets?has_content>
        <#list layoutSettings.styleSheets as styleSheet>
            <link rel="stylesheet" href="<@fadpContentUrl>${StringUtil.wrapString(styleSheet)}</@fadpContentUrl>" media="screen,projection" type="text/css" charset="UTF-8"/>
        </#list>
    </#if>
    ...
    <#if layoutSettings.javaScripts?has_content>
      ...
      <#assign javaScriptsSet = Static["com.hanlin.fadp.base.util.UtilMisc"].toSet(layoutSettings.javaScripts)/>
...
<div id="wrap">
  ...
  <div id="header">
    <#if organizationLogoLinkURL?has_content>
        <div id="org-logo-area"><a href="<@fadpUrl>${logoLinkURL}</@fadpUrl>"><img alt="${layoutSettings.companyName}" src="<@fadpContentUrl>${StringUtil.wrapString(organizationLogoLinkURL)}</@fadpContentUrl>" height="43px"></a></div>
        <#else>
        <div id="logo"></div>
    </#if>
    <div id="shelf"></div>
    <div id="controls">
            <span id="prefBtn">
                ...
                <span id="preferences" style="display:none">
                    <a href="<@fadpUrl>ListLocales</@fadpUrl>" id="language">${uiLabelMap.CommonLanguageTitle} - ${locale.getDisplayName(locale)}</a>
                    <a href="<@fadpUrl>ListTimezones</@fadpUrl>" id="timezone">${nowTimestamp?datetime?string.short} - ${timeZone.getDisplayName(timeZone.useDaylightTime(), Static["java.util.TimeZone"].LONG, locale)}</a>
                    <a href="<@fadpUrl>ListVisualThemes</@fadpUrl>" id="theme">${uiLabelMap.CommonVisualThemes}</a>
                </span>
            </span>
            <span>
            ...
            <span><a href="<@fadpUrl>logout</@fadpUrl>">${uiLabelMap.CommonLogout}</a></span>
