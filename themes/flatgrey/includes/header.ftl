...
<head>
    ...
    <#if layoutSettings.styleSheets?has_content>
        ...
        <#list layoutSettings.styleSheets as styleSheet>
            <link rel="stylesheet" href="<@fadpContentUrl>${StringUtil.wrapString(styleSheet)}</@fadpContentUrl>" type="text/css"/>
        </#list>
    </#if>
    ...
    <ul>
      ...
      <#if headerImageUrl??>
        <#if organizationLogoLinkURL?has_content>
            <li class="org-logo-area"><a href="<@fadpUrl>${logoLinkURL}</@fadpUrl>"><img alt="${layoutSettings.companyName}" src="<@fadpContentUrl>${StringUtil.wrapString(organizationLogoLinkURL)}</@fadpContentUrl>"></a></li>
            <#else>
            <li class="logo-area"><a href="<@fadpUrl>${logoLinkURL}</@fadpUrl>"><img alt="${layoutSettings.companyName}" src="<@fadpContentUrl>${StringUtil.wrapString(headerImageUrl)}</@fadpContentUrl>"/></a></li>
        </#if>
      </#if>
      ...
      <li class="preference-area">
          ...
          <#else/>
            <li>${uiLabelMap.CommonWelcome}! <a href="<@fadpUrl>${checkLoginUrl}</@fadpUrl>">${uiLabelMap.CommonLogin}</a></li>
          </#if>
