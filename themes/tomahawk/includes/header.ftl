        ...
        <ul>
          ...
          <#if headerImageUrl??>
            <#if organizationLogoLinkURL?has_content>
                <li id="org-logo-area"><a href="<@fadpUrl>${logoLinkURL}</@fadpUrl>"><img alt="${layoutSettings.companyName}" src="<@fadpContentUrl>${StringUtil.wrapString(organizationLogoLinkURL)}</@fadpContentUrl>"></a></li>
                <#else>
                <li id="logo-area"><a href="<@fadpUrl>${logoLinkURL}</@fadpUrl>" title="${layoutSettings.companyName}"></a></li>
            </#if>
          </#if>
